...
func makeService(t *testing.T) *ServiceMDNS {
	return makeServiceWithServiceName(t, "_http._tcp")
}

func makeServiceWithServiceName(t *testing.T, service string) *ServiceMDNS {
	m, err := NewServiceMDNS(
		"hostname",
		service,
		"local.",
		"testhost.",
